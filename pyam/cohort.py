...
class Student:
    ...
    def hash(self) -> int:
        """Return a hash based on students username - this will be first integer of first 8 characters of md5sum of username"""
        return int("0x"+hashlib.md5(self.username.encode()).hexdigest()[:8],0)
